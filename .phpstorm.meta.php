...
namespace PHPSTORM_META {
    ...
    override(\Serafim\SDL\TTF\TTF::addr(), map([
        '' => '@Ptr',
    ]));
    expectedArguments(\Serafim\SDL\TTF\TTF::new(), 0, argumentsSet('ffiCType'));
    expectedArguments(\Serafim\SDL\TTF\TTF::cast(), 0, argumentsSet('ffiCType'));
}
