...
namespace PHPSTORM_META {
    ...
    override(\Serafim\SDL\TTF\TTF::new(0), map([
...
namespace Serafim\SDL\TTF {
    interface TTF
    {
        ...
        /**
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $major
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $minor
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $patch
         */
         ...
         * @param null|\FFI\CData|array{\PHPSTORM_META\TTFFont} $font
         * @param int<0, 65536> $ch
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $minx
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $maxx
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $miny
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $maxy
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $advance
         * @return int<-2147483648, 2147483647>
         */
        ...
        /**
         * @param null|\FFI\CData|array{\PHPSTORM_META\TTFFont} $font
         * @param null|\FFI\CData|object{cdata:int<0, 65536>} $text
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $w
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $h
         * @return int<-2147483648, 2147483647>
         */
         ...
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $extent
         * @param null|\FFI\CData|object{cdata:int<-2147483648, 2147483647>} $count
         * @return int<-2147483648, 2147483647>
         */
